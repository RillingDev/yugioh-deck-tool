...
const ARCHETYPES = [
  [
    "ABC",
    ["ABC-Dragon Buster", "A-Assault Core", "B-Buster Drake", "C-Crush Wyvern"],
  ...
  [
    "Kuriboh",
    [],
    ["One for One", "Mimiclay", "Where Arf Thou?", "Wolf in Sheep's Clothing"]
  ],
  ["Laval", [], []],
  [
    "Legendary Knight",
  ...
  [
    "Odd-Eyes",
    [],
    ["Tuning Magician", "Pendulum Call", "Duelist Alliance", "Draconnection"]
  ],
  ...
  [
    ...
    ["United We Stand", "Solidarity", "Gravity Bind", "First of the Dragons"]
  ],
  [
    "Paleozoic",
    [],
  ...
  ["Resonator", [], []],
  ["Ritual Beast", ["Spiritual Beast"], ["Emergency Teleport", "Book of Moon"]],
  [
    "Roid",
    ["Polymerization", "Fusion Substitute", "Ultra Polymerization"],
    [
  ...
  ["Spiritual Beast", ["Ritual Beast"], ["Emergency Teleport", "Book of Moon"]],
  [
    "SPYRAL",
    [],
    [
  ...
  [
    "Venom",
    [],
    ["Snake Rain", "Damage = Reptile", "Limit Reverse", "Call of the Haunted"]
  ],
  [
    "Volcanic",
    [],
