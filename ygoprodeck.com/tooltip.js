    ...
    var tooltip = {
        open: function(e) {
            ...
            jQuery.getJSON(url, function(data) {
                ...
                var priceUrl =
                    "https://ygoprodeck.com/decktool/api/prices/prices.php?n=" +
                ...
                if (
                    ...
                    tooltip.html(
                        '<img src="' +
                            ...
                            data.race +
                            '.png" style="height: 20px; width: 20px; float: left; padding-right: 5px; display: inline-block; vertical-align:top; margin:0;padding-top:2px;">' +
                            data.race +
                            " " +
                            data.type +
                            "</div>" +
