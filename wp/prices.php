                ...
                <div class="main-row">
                    <div class="main-deck">
                        ...
                        <div class="deck" v-if="ajax.namesLoaded">
                            ...
                            <div class="deck-part" v-for="deckpart in deckparts" v-if="deck.list[deckpart.id] &amp;&amp; deck.list[deckpart.id].length" v-bind:class="'deck-part-'+deckpart.id">
                                <div class="deck-title">
                    ...
                    <div class="main-builder">
                        ...
                        <div class="builder">
                            ...
                            <ul class="builder-list" v-if="ajax.namesLoaded">
